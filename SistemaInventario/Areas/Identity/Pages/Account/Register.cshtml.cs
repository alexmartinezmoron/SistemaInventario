...
namespace SistemaInventario.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            ReturnUrl = returnUrl;
            // utilizamos inputmodel para llenar la lista de roles
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new Modelos.UsuarioAplicacion
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Buscamos si existe el rol y en caso de no existir lo creamos,
                    ...
                    // De momento le asignamos rol admin a todos los usuarios vamos creado
                    //await _userManager.AddToRoleAsync(user, DS.Role_Admin);

                    if (user.Role == null) // si el admin no le asigna nada es un cliente
                    {
                    ...
                    else
                    {
                        ...
                        {
                            // el admin esta registrando nuevos usuarios por lo que no queremos que se logue con ese usuario nuevo
